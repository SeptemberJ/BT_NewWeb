...
class Content extends React.Component {
  ...
  render() {
    ...
    return (
      <div {...props} className="content-template-wrapper content5-wrapper" style={{height:'auto'}}>
        <div
        ...
        >
          ...
          <TweenOne
            ...
            resetStyleBool
          >
            <img width="100%" src="https://gaopin-preview.bj.bcebos.com/133103600930.jpg@!420" />
          </TweenOne>
        </div>
      </div>
    );
